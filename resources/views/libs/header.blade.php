        ...
        <div class="l-container">
            <div class="c-header__navbar">
                <ul class="c-header__menuList">
                    <li class="c-header__menuItem"><a href="#">Home</a></li>
                    <li class="c-header__menuItem">
                        <a href="#">Computer<i class="fa-solid fa-caret-down"></i></a>
                        <ul class="c-header__childList">
                            <li><a href="#" class="c-header__itemChild">PC Gaming</a></li>
                            <li><a href="#" class="c-header__itemChild">PC Office</a></li>
                            <li><a href="#" class="c-header__itemChild">PC Old</a></li>
                        </ul>
                    </li>
                    <li class="c-header__menuItem"><a href="#">Laptop<i class="fa-solid fa-caret-down"></i></a></li>
                    <li class="c-header__menuItem"><a href="#">Gear<i class="fa-solid fa-caret-down"></i></a></li>
                    <li class="c-header__menuItem"><a href="#">Monitor<i class="fa-solid fa-caret-down"></i></a></li>
                    <li class="c-header__menuItem"><a href="#">Network<i class="fa-solid fa-caret-down"></i></a></li>
                    <li class="c-header__menuItem"><a href="#">Contact</a></li>
                </ul>
