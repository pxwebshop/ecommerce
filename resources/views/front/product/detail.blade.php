                ...
                <div class="c-block1">
                        ...
                        <div class="c-block1__content">
                            ...
                            <div class="c-block1__slider">
                                <figure class="c-block1__img">
                                    <img src="https://templates.envytheme.com/ejon/default/assets/img/quick-view/quick-view-1.jpg"
                                        alt="">
                                </figure>
                                <figure class="c-block1__img">
                                    <img src="https://templates.envytheme.com/ejon/default/assets/img/quick-view/quick-view-2.jpg"
                                        alt="">
                                </figure>
                                <figure class="c-block1__img">
                                    <img src="https://templates.envytheme.com/ejon/default/assets/img/quick-view/quick-view-3.jpg"
                                        alt="">
                                </figure>
                            </div>
                        </div>
                    ...
                    <div class="c-block1__right">
                        ...
                        <div class="c-price1 c-block1__price">
                            <span
                                class="c-price1--lineThrough c-block1__price1">{{ number_format($product->price) }}<sup>đ</sup></span>
                            <span
                                class="c-price1 c-block1__price2">{{ number_format($product->sale_price) }}<sup>đ</sup></span>
                        </div>
                        <p class="c-text1 c-block1__txt">{{ $product->description }}</p>
                        <ul class="c-block1__info">
                            <li class="c-block1__stock">
                                <p class="c-text1 c-block1__txt"><span class="c-text1--bold">Availability: </span>
                                    {{ $productDetail->stock }}</p>
                            </li>
                            <li class="c-block1__stock">
                                <p class="c-text1 c-block1__txt"><span class="c-text1--bold">SKU: </span>
                                    {{ $productDetail->sku }}</p>
                            </li>
                        </ul>
                            ...
                            <div class="c-list1__item">
                                <div class="c-list1__wrap">
                                    ...
                                    <div class="c-list1__content">
                                        ...
                                        <p class="c-price1">{{ number_format($relatedProduct->sale_price) }}
                                            <sup>đ</sup> </p>
                                    </div>
                                </div>
                            </div>
